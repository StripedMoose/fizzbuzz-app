...
PolicyCloudwatch = t.add_resource(PolicyType(
    'FizzbuzzCloudWatchPolicy',
    PolicyName='FizzbuzzCloudWatchPolicy',
    PolicyDocument={'Version': '2012-10-17',
...
ECSAutoScalingGroup = t.add_resource(AutoScalingGroup(
    ...
    MinSize='1',
    MaxSize='1',
    VPCZoneIdentifier=['subnet-e2821987', 'subnet-cfae5de4'],
